...
const formatTime = (timeInSeconds) => {
    const minuts = Math.floor(timeInSeconds / 60).toString().padStart(2, '0')
    const seconds = Math.floor(timeInSeconds - minuts * 60).toString().padStart(2, '0')
...
const timeInSeconds = (timeString) => {
    ...
    const minuts = Number(splitArray[0])
